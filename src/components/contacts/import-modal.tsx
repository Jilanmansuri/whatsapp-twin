...
export function ImportModal({ open, onOpenChange, onImported }: ImportModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="bg-card border-border text-foreground sm:max-w-lg rounded-2xl shadow-md">
        <DialogHeader>
          <DialogTitle className="text-foreground font-semibold">Import Contacts</DialogTitle>
        ...
        <div className="space-y-4">
          ...
          <div
            ...
            className="flex flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-border bg-secondary/35 p-6 cursor-pointer hover:border-primary/50 transition-colors"
          >
            {file ? (
              <>
                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="bg-secondary/60">
                      <th className="px-3 py-1.5 text-left text-muted-foreground font-semibold">Phone</th>
                      <th className="px-3 py-1.5 text-left text-muted-foreground font-semibold">Name</th>
                      <th className="px-3 py-1.5 text-left text-muted-foreground font-semibold">Email</th>
                      <th className="px-3 py-1.5 text-left text-muted-foreground font-semibold">Company</th>
                    </tr>
                  </thead>
                  <tbody>
                    {preview.map((row, i) => (
          ...
          {result && (
            <div className="rounded-xl border border-border p-4 space-y-2">
              ...
              <div className="flex items-center gap-4">
                ...
                {result.failed > 0 && (
                  <div className="flex items-center gap-1.5 text-red-650 text-sm font-medium">
        ...
        <DialogFooter className="bg-card border-border border-t pt-4">
          <Button
            type="button"
            variant="outline"
