    ...
    <div className="space-y-4 mt-4">
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="bg-popover border-border sm:max-w-sm">
          <DialogHeader>
            <DialogTitle className="text-foreground font-semibold">New Tag</DialogTitle>
                ...
                {PRESET_COLORS.map((color) => (
                  <button
                    ...
                    style={{
                      ...
                      boxShadow: selectedColor === color.value ? `0 0 0 2px rgb(255 255 255), 0 0 0 4px ${color.value}` : 'none',
                    }}
                    title={color.name}
                  />
                ))}
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent className="bg-popover border-border sm:max-w-sm">
          <DialogHeader>
            <DialogTitle className="text-foreground font-semibold">Delete Tag</DialogTitle>
            <DialogDescription className="text-muted-foreground">
