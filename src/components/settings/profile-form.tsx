...
export function ProfileForm() {
  ...
  return (
    <Card className="bg-card border-border shadow-sm">
      <CardHeader>
        <CardTitle className="text-foreground font-semibold">Profile</CardTitle>
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="flex flex-wrap items-center gap-5">
            <Avatar size="lg" className="size-16">
              ...
              <AvatarFallback className="bg-primary/10 text-base text-primary font-semibold">
                {initial}
              </AvatarFallback>
            </Avatar>
          ...
          {/* Read-only block */}
          <div className="rounded-lg border border-border bg-[#f5f5f7]/40 p-4">
