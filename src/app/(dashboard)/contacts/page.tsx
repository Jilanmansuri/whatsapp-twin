    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            onClick={openAddForm}
            className="bg-primary hover:bg-primary/95 text-white hover:shadow-sm active:scale-95 transition-all rounded-xl font-medium"
          >
      ...
      <div className="relative max-w-sm">
        ...
        <Input
          ...
          className="pl-8 bg-card border-border text-foreground placeholder:text-muted-foreground focus-visible:border-primary focus-visible:ring-primary/20 rounded-xl"
        />
      </div>
                  ...
                  <div className="flex flex-col items-center gap-2">
                    ...
                    {!search && (
                      <Button
                        ...
                        size="sm"
                        onClick={openAddForm}
                        className="mt-2 border-border text-foreground hover:bg-secondary rounded-xl"
                      >
                    ...
                    <DropdownMenu>
                      ...
                      >
                        <DropdownMenuItem
                          ...
                          className="text-foreground focus:bg-secondary focus:text-foreground font-medium"
                        >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <Button
              ...
              className="border-border text-foreground hover:bg-secondary disabled:opacity-30 rounded-xl"
            >
      ...
      <Dialog open={deleteConfirmOpen} onOpenChange={setDeleteConfirmOpen}>
        <DialogContent className="bg-card border-border text-foreground sm:max-w-sm rounded-2xl shadow-md">
          <DialogHeader>
            <DialogTitle className="text-foreground font-semibold">Delete Contact</DialogTitle>
