...
function RateCell({
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="w-10 text-right text-xs tabular-nums text-muted-foreground font-medium">
        {pct}%
      </span>
      <div className="h-1.5 w-20 overflow-hidden rounded-full bg-secondary border border-border/10">
        <div
...
export default function BroadcastsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {broadcasts.length === 0 ? (
        <div className="flex h-64 flex-col items-center justify-center rounded-2xl border border-border bg-card shadow-sm">
          ...
          <Button
            onClick={() => router.push('/broadcasts/new')}
            className="mt-4 bg-primary text-white hover:bg-primary/95 hover:shadow-sm active:scale-95 transition-all rounded-xl font-medium"
          >
            <Plus className="h-4 w-4" />
            New Broadcast
          </Button>
